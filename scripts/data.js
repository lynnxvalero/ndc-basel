...
const SHOWGROUPS = [
  ...
  // ── UNCONFIRMED (not in current Stundenplan) ──────────────
  {
    id:'project-x', name:'Project X',
    teacherId:'jasmin',
    tag_de:'Pro', tag_en:'Pro',
    blurb_de:'[Platzhalter – bitte bestätigen ob Project X noch aktiv ist]',
    blurb_en:'[Placeholder – please confirm whether Project X is still active]',
    status:'unconfirmed',
  },
  {
    id:'urbansteps', name:'UrbanSteps',
    teacherId:null,
    tag_de:'Youth', tag_en:'Youth',
    blurb_de:'[Platzhalter – bitte bestätigen ob UrbanSteps noch aktiv ist]',
    blurb_en:'[Placeholder – please confirm whether UrbanSteps is still active]',
    status:'unconfirmed',
  },
];
